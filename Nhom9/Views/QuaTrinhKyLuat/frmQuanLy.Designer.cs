namespace VB2QLNS.Views.QuaTrinhKyLuat
{
    partial class frmQuanLy
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox2.Size = new System.Drawing.Size(548, 401);
			this.groupBox2.TabIndex = 9;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "Thông tin quá trình kỷ luật";
			// 
			// statusStrip1
			// 
			...
			this.toolStrip2.Size = new System.Drawing.Size(548, 39);
			...
			this.dgvwQuaTrinhHopDong.Size = new System.Drawing.Size(542, 358);
			this.dgvwQuaTrinhHopDong.TabIndex = 2;
			this.dgvwQuaTrinhHopDong.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dgvwQuaTrinhHopDong_CellDoubleClick);
			// 
			// Column2
			// 
			...
			// TienLuong
			// 
			this.TienLuong.DataPropertyName = "NhanSuId";
			this.TienLuong.HeaderText = "Mã nhân sự";
			this.TienLuong.Name = "TienLuong";
			this.TienLuong.ReadOnly = true;
			this.TienLuong.Visible = false;
			// 
			// TuNgay
			// 
			...
			// 
			this.HinhThucHuongLuongId.DataPropertyName = "HinhThuc";
			this.HinhThucHuongLuongId.HeaderText = "Hình thức";
			this.HinhThucHuongLuongId.Name = "HinhThucHuongLuongId";
			this.HinhThucHuongLuongId.ReadOnly = true;
			// 
			// PhongBanId
			// 
			this.PhongBanId.DataPropertyName = "LyDo";
			this.PhongBanId.HeaderText = "Lý do";
			this.PhongBanId.Name = "PhongBanId";
			this.PhongBanId.ReadOnly = true;
			// 
			// ChucVuId
			// 
			this.ChucVuId.DataPropertyName = "GiaTri";
			this.ChucVuId.HeaderText = "Giá trị";
			...
			this.Name = "frmQuanLy";
			this.Size = new System.Drawing.Size(548, 440);
