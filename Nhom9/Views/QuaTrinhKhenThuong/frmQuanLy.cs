...
namespace VB2QLNS.Views.QuaTrinhKhenThuong
{
	...
	{
		private QuaTrinhKhenThuongController ctrlQuaTrinhKhenThuong;
		...
		public frmQuanLy(int nhanSuId = 0)
		{
			...
			ctrlQuaTrinhKhenThuong = new QuaTrinhKhenThuongController();
		...
		{
			LoadData(ctrlQuaTrinhKhenThuong.dataAccess.Query(QuaTrinhKhenThuongModel.TableName + "_FindAllByNhanSu", nhanSuId));
		}
		...
		private void m_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
		{
			...
			switch (e.ClickedItem.Name.ToString())
			{
				...
				case "Delete":
					...
					{
						ctrlQuaTrinhKhenThuong.Delete(new QuaTrinhKhenThuongModel() { Id = idRecord });
					}
					break;
			}
